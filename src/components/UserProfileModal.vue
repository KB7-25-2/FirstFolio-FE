    ...
    >
      ...
      <label class="mt-5 flex flex-col gap-1.5" for="profile-nickname">
        ...
        <input
          ...
          :disabled="isSaving"
          class="rounded-xl border-[0.5px] border-[rgba(245,237,217,0.14)] bg-[#0d1117] px-3 py-2.5 font-serif text-[13px] text-[#f5edd9] outline-none placeholder:text-[rgba(245,237,217,0.28)] focus:border-[rgba(193,127,36,0.55)] disabled:opacity-50"
          placeholder="2~10자"
        />
      ...
      <label
        class="mt-4 flex cursor-pointer items-center justify-between gap-3 rounded-xl border-[0.5px] border-[rgba(245,237,217,0.1)] bg-white/[0.02] px-3.5 py-3"
