  ...
  >
    ...
    >
      ...
      <div class="mt-6 flex gap-2">
        <button
          type="button"
          class="btn-hover flex-1 rounded-xl border border-[rgba(245,237,217,0.18)] py-2.5 font-serif text-[13px] text-[rgba(245,237,217,0.85)] disabled:opacity-40"
        ...
        <button
          ...
          :class="
            confirmVariant === 'danger'
              ? 'border border-[rgba(220,80,80,0.45)] bg-[rgba(220,80,80,0.18)] text-[#f0b4b4]'
